        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(mTask)) {
                    task.setError("Task tidak boleh kosong");
                    return;
                }
                if (TextUtils.isEmpty(mDescription)) {
                    description.setError("Description tidak boleh kosong");
                    return;
                } else {
                ...
                reference.child(key).setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(HomeActivity.this, "Update data gagal "+err, Toast.LENGTH_SHORT).show();
                        }
        ...
        delButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                reference.child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(HomeActivity.this, "Task berhasil dihapus", Toast.LENGTH_SHORT).show();
                        }else {
                            String err = task.getException().toString();
                            Toast.makeText(HomeActivity.this, "Task gagal dihapus "+ err, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                dialog.dismiss();
